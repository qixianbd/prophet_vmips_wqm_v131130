...
Options::usage(char *argv0)
{
	...
	"\n"
	"Report bugs to <dongzhaoyu_th@163.com>.\n",
	PACKAGE, PACKAGE);
}
...
Options::print_package_version(char *toolname, char *version)
{
	printf(
	"\n*************************************%s %s***********************************\n"
	"\tCopyright (C) 2009 by Dongzhaoyu Gaobing. \n"
	"\t%s is developed based on vmips by Brian R. Gaeke and others.\n"
	...
	"\t59 Temple Place - Suite 330, Boston, MA 02111-1307, USA.\n\n",
	toolname, version, toolname, toolname, toolname, toolname, toolname);
}
