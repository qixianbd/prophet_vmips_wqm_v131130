...
bin_PROGRAMS = prophet_vmips$(EXEEXT) vmipstool$(EXEEXT)
subdir = .
DIST_COMMON = README $(am__configure_deps) $(noinst_HEADERS) \
	$(srcdir)/Makefile.am $(srcdir)/Makefile.in \
	$(srcdir)/config.h.in $(srcdir)/vmips.spec.in \
	$(srcdir)/vmipsrc.in $(top_srcdir)/configure \
	$(top_srcdir)/doc/Makefile.in \
	$(top_srcdir)/sample_code/Makefile.in \
	$(top_srcdir)/sample_code/xmboot/Makefile.in AUTHORS COPYING \
...
CONFIG_CLEAN_FILES = vmips.spec vmipsrc doc/Makefile \
	sample_code/Makefile sample_code/xmboot/Makefile
am__installdirs = "$(DESTDIR)$(bindir)" "$(DESTDIR)$(sysconfdir)"
binPROGRAMS_INSTALL = $(INSTALL_PROGRAM)
PROGRAMS = $(bin_PROGRAMS)
am_prophet_vmips_OBJECTS = clock.$(OBJEXT) clockdev.$(OBJEXT) \
	cpu.$(OBJEXT) cpzero.$(OBJEXT) debug.$(OBJEXT) \
	deccsr.$(OBJEXT) decrtc.$(OBJEXT) decserial.$(OBJEXT) \
	decstat.$(OBJEXT) deviceint.$(OBJEXT) devicemap.$(OBJEXT) \
	error.$(OBJEXT) exeloader.$(OBJEXT) fileutils.$(OBJEXT) \
	haltdev.$(OBJEXT) intctrl.$(OBJEXT) mapper.$(OBJEXT) \
	options.$(OBJEXT) prophetlog.$(OBJEXT) range.$(OBJEXT) \
	remotegdb.$(OBJEXT) rommodule.$(OBJEXT) \
	speculativecpu.$(OBJEXT) speculativelogic.$(OBJEXT) \
	spimconsole.$(OBJEXT) stub-dis.$(OBJEXT) \
	terminalcontroller.$(OBJEXT) prophetfpu.$(OBJEXT) \
	prophetconsole.$(OBJEXT) prophetxmlelement.$(OBJEXT) \
	prophetxmldoc.$(OBJEXT) prophetstatistic.$(OBJEXT) \
	vmips.$(OBJEXT) prophet_vmips.$(OBJEXT)\
	prophetcpustat.$(OBJEXT)
prophet_vmips_OBJECTS = $(am_prophet_vmips_OBJECTS)
prophet_vmips_DEPENDENCIES =  \
	$(top_builddir)/libopcodes_mips/libopcodes_mips.a \
	libopcodes_mips/libopcodes_mips.a
am_vmipstool_OBJECTS = vmipstool.$(OBJEXT) options.$(OBJEXT) \
	error.$(OBJEXT) stub-dis.$(OBJEXT) fileutils.$(OBJEXT)
vmipstool_OBJECTS = $(am_vmipstool_OBJECTS)
...
SOURCES = $(prophet_vmips_SOURCES) $(vmipstool_SOURCES)
DIST_SOURCES = $(prophet_vmips_SOURCES) $(vmipstool_SOURCES)
...
TESTCODE_DIR = 
VERSION = 1.3.2
abs_builddir = /home/qmwx/project/prophet_vmips_final_keyming_131130
abs_srcdir = /home/qmwx/project/prophet_vmips_final_keyming_131130
...
AM_CXXFLAGS = -I$(top_srcdir)/libopcodes_mips -g -Wall -fno-strict-aliasing \
...
prophet_vmips_SOURCES = accesstypes.h clock.cc clock.h clockdev.cc clockdev.h \
	...
	prophetcpustat.cc prophetcpustat.h
...
vmips.spec: $(top_builddir)/config.status $(srcdir)/vmips.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
vmipsrc: $(top_builddir)/config.status $(srcdir)/vmipsrc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
doc/Makefile: $(top_builddir)/config.status $(top_srcdir)/doc/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
sample_code/Makefile: $(top_builddir)/config.status $(top_srcdir)/sample_code/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
sample_code/xmboot/Makefile: $(top_builddir)/config.status $(top_srcdir)/sample_code/xmboot/Makefile.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
prophet_vmips$(EXEEXT): $(prophet_vmips_OBJECTS) $(prophet_vmips_DEPENDENCIES) 
	@rm -f prophet_vmips$(EXEEXT)
	$(CXXLINK) $(prophet_vmips_OBJECTS) $(prophet_vmips_LDADD) $(LIBS)
vmipstool$(EXEEXT): $(vmipstool_OBJECTS) $(vmipstool_DEPENDENCIES) 
	@rm -f vmipstool$(EXEEXT)
	$(CXXLINK) $(vmipstool_OBJECTS) $(vmipstool_LDADD) $(LIBS)
...
include ./$(DEPDIR)/clockdev.Po
include ./$(DEPDIR)/cpu.Po
include ./$(DEPDIR)/cpzero.Po
include ./$(DEPDIR)/debug.Po
include ./$(DEPDIR)/deccsr.Po
include ./$(DEPDIR)/decrtc.Po
include ./$(DEPDIR)/decserial.Po
include ./$(DEPDIR)/decstat.Po
include ./$(DEPDIR)/deviceint.Po
include ./$(DEPDIR)/devicemap.Po
include ./$(DEPDIR)/error.Po
include ./$(DEPDIR)/exeloader.Po
include ./$(DEPDIR)/fileutils.Po
include ./$(DEPDIR)/haltdev.Po
include ./$(DEPDIR)/intctrl.Po
include ./$(DEPDIR)/mapper.Po
include ./$(DEPDIR)/options.Po
include ./$(DEPDIR)/prophet_vmips.Po
include ./$(DEPDIR)/prophetconsole.Po
include ./$(DEPDIR)/prophetfpu.Po
include ./$(DEPDIR)/prophetlog.Po
include ./$(DEPDIR)/prophetstatistic.Po
include ./$(DEPDIR)/prophetxmldoc.Po
include ./$(DEPDIR)/prophetxmlelement.Po
include ./$(DEPDIR)/range.Po
include ./$(DEPDIR)/remotegdb.Po
include ./$(DEPDIR)/rommodule.Po
include ./$(DEPDIR)/speculativecpu.Po
include ./$(DEPDIR)/speculativelogic.Po
include ./$(DEPDIR)/spimconsole.Po
include ./$(DEPDIR)/stub-dis.Po
include ./$(DEPDIR)/terminalcontroller.Po
include ./$(DEPDIR)/vmips.Po
include ./$(DEPDIR)/vmipstool.Po
