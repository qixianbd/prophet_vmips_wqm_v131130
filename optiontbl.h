...
static Option nametable[] = {
    ...
    { "corenum", NUM },
    /** the number of cores in the virtual machine. This value must be greater
	than 0. If equals 1, the virtual machine will execute the program in a
	sequential manner. If greater than 1, the virtual machine will execute
	the specified program in a speculative manner. **/

    { "filelog", FLAG },
    /** If this option is set, the prophetlog module will dump the log info
	into a log file "log.txt". This file will be generated in your work
	directory **/

    { "consolelog", FLAG },
    /** If this option is set, the prophetlog module will output the log info
	onto the standard output console. **/
